...
public class StageRandomSelector : Composite
{
    public SharedInt CurrentStage;
    public List<string> IncludedTasksPerStatge;
    ...
    public override void OnStart()
    {
        ...
        childIndexList = IncludedTasksPerStatge[CurrentStage.Value].Split(',').Select(int.Parse).ToList();
